                        ...
                        <div class="items">
                            <ul>
                                ...
                                <#list imageList as image>
                                    <li><img src="${image.url}" bimg="../img/_/b1.png" onmousemove="preview(this)" /></li>
                                </#list>
                        ...
                        <#list specificationList as spec>
                            <dl>
                                ...
                                <#list spec.attributeValue as attrValue>
                                    <dd><a ng-click="selectSpecification('${spec.attributeName}','${attrValue}')"  href="javascript:;"
                                           class="{{isSelected('${spec.attributeName}','${attrValue}')?'selected':''}}">${attrValue}
                        ...
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="javascript:void(0)" ng-click="addItem()" class="increment plus">+</a>
                                    <a href="javascript:void(0)" ng-click="deleteItem()" class="increment mins">-</a>
                                </div>
                            </div>
                        </div>
                        <div class="fl">
                    ...
                    <ul class="sui-nav nav-tabs tab-wraped">
                        <li class="active">
                            <a href="#one" data-toggle="tab">
                                <span>${goodsDesc.introduce!}</span>
                            </a>
                        </li>
                        <li>
                            <a href="#two" data-toggle="tab">
                                <span>${goodsDesc.packageList!}</span>
                            </a>
                        </li>
                        <li>
                            <a href="#three" data-toggle="tab">
                                <span>${goodsDesc.saleService!}</span>
                            </a>
                        </li>
                        <li>
